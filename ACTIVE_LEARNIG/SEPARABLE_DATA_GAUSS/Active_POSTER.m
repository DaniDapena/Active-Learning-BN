...
PathL=[2.3086  1.5441 1.049 0.69707]; %incomplete
...
load('EXP_NS')
density = [0.01 0.02 0.04 0.08];
PathL=[3.797 2.5372 1.7188 1.1295];
...
[SF,sig,Pat_1,PAT_D] = Active_v05(I_VC,PathL,L,Trainig_classes,Wgeos);
